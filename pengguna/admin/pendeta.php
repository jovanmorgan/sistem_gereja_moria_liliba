  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <div id="popup-tambah" class="popup">
      <div class="popup-content">
        ...
        <hr>
        <h2>Tambah Data</h2>
        <form id="form_tambah" action="proses/pendeta/tambah.php" method="POST" enctype="multipart/form-data">
          ...
          <label for="nohp-tambah">NO HP:</label>
          <input type="text" id="nohp-tambah" name="nohp" required>
    ...
    <div id="popup-edit" class="popup">
      <div class="popup-content">
        ...
        <hr>
        <h2>Edit Data</h2>
        <form id="form_edit" action="proses/pendeta/edit.php" method="POST" enctype="multipart/form-data">
          <input type="hidden" id="id_pendeta_edit" name="id_pendeta" required>
    ...
    <!-- js edit -->
    <script>
      function openEditModal(id_pendeta, nama, jenis_kelamin, alamat, username, password) {
        alamat_data = alamat.replace(/<br\s*\/?>/gi, '\n');
        // Isi data ke dalam form edit
        document.getElementById('id_pendeta_edit').value = id_pendeta;
              ...
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    ...
                    $search_sql = !empty($search_query) ? " WHERE nama LIKE '%$search_query%' OR jenis_kelamin LIKE '%$search_query%' OR alamat LIKE '%$search_query%' OR username LIKE '%$search_query%' OR password LIKE '%$search_query%'" : '';
                    ...
                    if (mysqli_num_rows($result) > 0) {
                      while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<a href='javascript:;' style='margin-left: 30px;' class='text-secondary font-weight-bold text-xs' data-toggle='tooltip' data-original-title='Delete user' onclick='hapus(\"" . $row['id_pendeta'] . "\")'>";
  ...
  <script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
      document.getElementById('form_tambah').addEventListener('submit', function (event) {
        ...
        xhr.open('POST', 'proses/pendeta/tambah.php', true);
        xhr.onload = function () {
    ...
    document.addEventListener('DOMContentLoaded', function () {
      document.getElementById('form_edit').addEventListener('submit', function (event) {
        ...
        var xhr = new XMLHttpRequest();
        xhr.open('POST', 'proses/pendeta/edit.php', true);
        xhr.onload = function () {
      ...
      swal({
        ...
        .then((willDelete) => {
          if (willDelete) {
            ...
            xhr.open('POST', 'proses/pendeta/hapus.php', true);
    ...
    function loadTable() {
      ...
      xhrTable.open('GET', 'proses/pendeta/load_table.php', true);
      xhrTable.send();
    }
  </script>
  <!--   Core JS Files   -->
