        ...
        <div class="col-12">
          <div class="card my-4">
            ...
            <div class="mt-3 p-3 d-flex flex-wrap align-items-center justify-content-center">
              ...
              <a href="proses/jenis_pelayanan/export" target="_blank" class="btn btn-info m-2">
                EXPORT
              </a>
                  ...
                  <tbody>
                    ...
                    if (mysqli_num_rows($result) > 0) {
                      while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<a href='javascript:;' style='margin-left: 30px;' class='text-secondary font-weight-bold text-xs' data-toggle='tooltip' data-original-title='Delete user' onclick='hapus(\"" . $row['id_jenis_pelayanan'] . "\")'>";
