  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <div id="popup-tambah" class="popup">
      <div class="popup-content">
        ...
        <hr>
        <h2>Tambah Data</h2>
        <form id="form_tambah" action="proses/majelis/tambah.php" method="POST" enctype="multipart/form-data">
          ...
          <label for="status-tambah">Status:</label>
          <select id="status-tambah" name="status" required>
    ...
    <div id="popup-edit" class="popup">
      <div class="popup-content">
        ...
        <hr>
        <h2>Edit Data</h2>
        <form id="form_edit" action="proses/majelis/edit.php" method="POST" enctype="multipart/form-data">
          <input type="hidden" id="id_majelis_edit" name="id_majelis" required>
    ...
    <!-- js edit -->
    <script>
      function openEditModal(id_majelis, nama, umur, alamat, jenis_kelamin, status) {
        alamat_data = alamat.replace(/<br\s*\/?>/gi, '\n');
        // Isi data ke dalam form edit
        document.getElementById('id_majelis_edit').value = id_majelis;
                  ...
                  <tbody>
                    ...
                    if (mysqli_num_rows($result) > 0) {
                      while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<td class='align-middle text-center'><span class='text-secondary text-xs font-weight-bold'>" . $row['status'] . "</span></td>";
  ...
  <script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
      document.getElementById('form_tambah').addEventListener('submit', function(event) {
        ...
        xhr.open('POST', 'proses/majelis/tambah.php', true);
        xhr.onload = function() {
    ...
    document.addEventListener('DOMContentLoaded', function() {
      document.getElementById('form_edit').addEventListener('submit', function(event) {
        ...
        var xhr = new XMLHttpRequest();
        xhr.open('POST', 'proses/majelis/edit.php', true);
        xhr.onload = function() {
      ...
      swal({
        ...
        .then((willDelete) => {
          if (willDelete) {
            ...
            xhr.open('POST', 'proses/majelis/hapus.php', true);
    ...
    function loadTable() {
      ...
      xhrTable.open('GET', 'proses/majelis/load_table.php', true);
      xhrTable.send();
    }
  </script>
