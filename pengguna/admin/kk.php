  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <div id="popup-tambah" class="popup">
      <div class="popup-content">
        ...
        <hr>
        <h2>Tambah Data</h2>
        <form id="form_tambah" action="proses/kepala_keluarga/tambah.php" method="POST" enctype="multipart/form-data">
          ...
          <select id="id_rayon-tambah" name="id_rayon" required>
    ...
    <div id="popup-edit" class="popup">
      <div class="popup-content">
        ...
        <hr>
        <h2>Edit Data</h2>
        <form id="form_edit" action="proses/kepala_keluarga/edit.php" method="POST" enctype="multipart/form-data">
          <input type="hidden" id="id_kepala_keluarga-edit" name="id_kepala_keluarga" required>

          <label for="id_rayon-edit"> Rayon :</label>
          <select id="id_rayon-edit" name="id_rayon" required>
            <option value="" selected>Pilih Rayon</option>
            <?php
            // Menggunakan include untuk menyertakan file koneksi
            include '../../keamanan/koneksi.php';
          ...
          <label for="no_hp">Nomor Hp :</label>
          <input type="number" id="no_hp-edit" min="0" name="no_hp" required>
    ...
    <!-- js edit -->
    <script>
      function openEditModal(id_kepala_keluarga, nama, nama_rayon, no_hp, username, password) {
        document.getElementById('id_kepala_keluarga-edit').value = id_kepala_keluarga;
        document.getElementById('nama-edit').value = nama;
        document.getElementById('id_rayon-edit').value = nama_rayon;
        ...
        <div class="col-12">
          <div class="card my-4">
            ...
            <div class="mt-3 p-3 d-flex flex-wrap align-items-center justify-content-center">
              ...
              <!-- tombol_export -->
              <a href="proses/kepala_keluarga/export?id_rayon=<?php echo $id_rayon; ?>" target="_blank" class="btn btn-info m-2">
                EXPORT
              </a>
              <!-- akhir tombol_export -->
              ...
              <div class="ms-md-auto pe-md-3 d-flex align-items-center m-2 w-100 w-md-auto">
                <form action="" method="GET" class="ms-md-auto pe-md-3 d-flex align-items-center m-2 w-100 w-md-auto">
                  <div class="input-group input-group-outline w-100">
                    <input type="hidden" name="id_rayon" value="<?php echo htmlspecialchars($id_rayon); ?>">
              ...
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    ...
                    $search_sql = !empty($search_query) ? " AND (kepala_keluarga.nama LIKE '%$search_query%' OR rayon.nama_rayon LIKE '%$search_query%' OR kepala_keluarga.no_hp LIKE '%$search_query%' OR kepala_keluarga.username LIKE '%$search_query%' OR kepala_keluarga.password LIKE '%$search_query%')" : '';
                    $count_query = "SELECT COUNT(*) AS total FROM kepala_keluarga LEFT JOIN rayon ON kepala_keluarga.id_rayon = rayon.id_rayon" . $search_sql;
                    ...
                    $data_query = "SELECT kepala_keluarga.*, rayon.nama_rayon AS nama_rayon FROM kepala_keluarga LEFT JOIN rayon ON kepala_keluarga.id_rayon = rayon.id_rayon" . $search_sql . " ORDER BY id_kepala_keluarga DESC LIMIT " . $starting_limit . ", " . $results_per_page;
                    ...
                    if (mysqli_num_rows($result) > 0) {
                      while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<a href='javascript:;' style='margin-left: 30px;' class='text-secondary font-weight-bold text-xs' data-toggle='tooltip' data-original-title='Delete user' onclick='hapus(\"" . $row['id_kepala_keluarga'] . "\")'>";
              ...
              <div class="d-flex justify-content-center mt-5">
                <nav aria-label="Page navigation example">
                  <ul class="pagination">
                    <?php if ($page > 1) : ?>
                      <li class="page-item">
                        <a class="page-link" href="?page=<?php echo $page - 1; ?>&search_query=<?php echo urlencode($search_query); ?>&id_rayon=<?php echo urlencode($id_rayon); ?>" aria-label="Previous">
                    ...
                    <?php for ($i = 1; $i <= $total_pages; $i++) : ?>
                      <li class="page-item <?php if ($i == $page)
                        ...
                        <a class="page-link <?php if ($i == $page)
                                              ...
                                              echo 'text-dark'; ?>" href="?page=<?php echo $i; ?>&search_query=<?php echo urlencode($search_query); ?>&id_rayon=<?php echo urlencode($id_rayon); ?>">
                          <?php echo $i; ?>
                        </a>
                      </li>
                    <?php endfor; ?>
                    <?php if ($page < $total_pages) : ?>
                      <li class="page-item">
                        <a class="page-link" href="?page=<?php echo $page + 1; ?>&search_query=<?php echo urlencode($search_query); ?>&id_rayon=<?php echo urlencode($id_rayon); ?>" aria-label="Next">
  ...
  <script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
      document.getElementById('form_tambah').addEventListener('submit', function(event) {
        ...
        xhr.open('POST', 'proses/kepala_keluarga/tambah.php', true);
        xhr.onload = function() {
    ...
    document.addEventListener('DOMContentLoaded', function() {
      document.getElementById('form_edit').addEventListener('submit', function(event) {
        ...
        var xhr = new XMLHttpRequest();
        xhr.open('POST', 'proses/kepala_keluarga/edit.php', true);
        xhr.onload = function() {
      ...
      swal({
        ...
        .then((willDelete) => {
          if (willDelete) {
            ...
            xhr.open('POST', 'proses/kepala_keluarga/hapus.php', true);
    ...
    function loadTable() {
      ...
      xhrTable.open('GET', 'proses/kepala_keluarga/load_table.php?id_rayon=<?php echo $id_rayon; ?>', true);
      xhrTable.send();
    }
  </script>
