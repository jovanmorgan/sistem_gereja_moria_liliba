...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-gradient-dark" id="sidenav-main" style="z-index: 10;">
    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link text-white <?php echo ($current_page == 'kk') ? 'active bg-gradient-primary' : ''; ?>" href="kk">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="material-icons opacity-10">home</i> <!-- Ikon untuk Kepala Keluarga -->
                    </div>
                    <span class="nav-link-text ms-1">Kepala Keluarga</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-white <?php echo ($current_page == 'jemaat') ? 'active bg-gradient-primary' : ''; ?>" href="jemaat">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class='fas fa-users'></i> <!-- Ikon untuk Jemaat -->
                    </div>
