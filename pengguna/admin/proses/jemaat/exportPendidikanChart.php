...
<head>
    ...
    <title>
        Export Data Pendidikan Terakhir | Gereja Moria Liliba
    </title>
            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header pb-0">
                        <h3 class="text-center">Data Jumlah Status Pernikahan</h3>
                    </div>
                    <div class="card-body">
        ...
        WHERE 1=1" . $search_sql . " ORDER BY id_jemaat DESC LIMIT " . $starting_limit . ", " . $results_per_page;
                                    ...
                                    if (mysqli_num_rows($result) > 0) {
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            echo "<td class='align-middle text-center'><span class='text-secondary text-xs font-weight-bold'>" . $row['tahun_pendidikan_terakhir'] . "</span></td>";
                                            echo "</tr>";
                                            $counter++;
                                        }
                                    } else {
