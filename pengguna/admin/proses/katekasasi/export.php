...
<head>
    ...
    <title>
        Export Data katekasasi | Gereja Moria Liliba
    </title>
            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header pb-0">
                        <h3 class="text-center">Data katekasasi</h3>
                    </div>
                    <div class="card-body">
                            ...
                            <table id="example" class="table table-striped table-bordered display nowrap" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    if (mysqli_num_rows($result) > 0) {
                                        ...
                                        echo "<tr><td colspan='5' class='align-middle text-center'><span class='text-secondary text-xs font-weight-bold'>Tidak Ada Data Yang Ditemukan..</span></td></tr>";
                                    }
                                    ?>
                                </tbody>
                            </table>
