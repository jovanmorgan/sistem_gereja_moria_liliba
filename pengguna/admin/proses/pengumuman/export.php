...
<head>
    ...
    <title>
        Export Data Jadwal Pelayanan | Gereja Moria Liliba
    </title>
            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header pb-0">
                        <h3 class="text-center">Data Jadwal Pelayanan</h3>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="example" class="table table-striped table-bordered display nowrap" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    $search_sql = !empty($search_query) ? " WHERE nama LIKE '%$search_query%' OR umur LIKE '%$search_query%' OR isi LIKE '%$search_query%' OR jenis_kelamin LIKE '%$search_query%'" : '';
