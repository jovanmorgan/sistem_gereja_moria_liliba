  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <div id="popup-tambah" class="popup">
      <div class="popup-content">
        ...
        <hr>
        <h2>Tambah Data</h2>
        <form id="form_tambah" action="proses/pembabtisan/tambah.php" method="POST" enctype="multipart/form-data">
    ...
    <div id="popup-edit" class="popup">
      <div class="popup-content">
        ...
        <hr>
        <h2>Edit Data</h2>
        <form id="form_edit" action="proses/pembabtisan/edit.php" method="POST" enctype="multipart/form-data">
          <input type="hidden" id="id_pembabtisan_edit" name="id_pembabtisan" required>
    ...
    <!-- js edit -->
    <script>
      function openEditModal(id_pembabtisan, nama, umur, jenis_kelamin) {
        // Isi data ke dalam form edit
        document.getElementById('id_pembabtisan_edit').value = id_pembabtisan;
              ...
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    ...
                    $search_sql = !empty($search_query) ? " WHERE nama LIKE '%$search_query%' OR umur LIKE '%$search_query%' OR jenis_kelamin LIKE '%$search_query%'" : '';
                    $count_query = "SELECT COUNT(*) AS total FROM pembabtisan" . $search_sql;
                    ...
                    $data_query = "SELECT * FROM pembabtisan" . $search_sql . " ORDER BY id_pembabtisan DESC LIMIT " . $starting_limit . ", " . $results_per_page;
                    ...
                    if (mysqli_num_rows($result) > 0) {
                      while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<a href='javascript:;' style='margin-left: 30px;' class='text-secondary font-weight-bold text-xs' data-toggle='tooltip' data-original-title='Delete user' onclick='hapus(\"" . $row['id_pembabtisan'] . "\")'>";
  ...
  <script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
      document.getElementById('form_tambah').addEventListener('submit', function(event) {
        ...
        xhr.open('POST', 'proses/pembabtisan/tambah.php', true);
        xhr.onload = function() {
    ...
    document.addEventListener('DOMContentLoaded', function() {
      document.getElementById('form_edit').addEventListener('submit', function(event) {
        ...
        var xhr = new XMLHttpRequest();
        xhr.open('POST', 'proses/pembabtisan/edit.php', true);
        xhr.onload = function() {
      ...
      swal({
        ...
        .then((willDelete) => {
          if (willDelete) {
            ...
            xhr.open('POST', 'proses/pembabtisan/hapus.php', true);
    ...
    function loadTable() {
      ...
      xhrTable.open('GET', 'proses/pembabtisan/load_table.php', true);
      xhrTable.send();
    }
  </script>
