...
<body translate="no" class="g-sidenav-show bg-gray-200">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <!-- js edit -->
    <script>
      function openEditModal(id_p_pelayanan, id_jenis_pelayanan, id_rayon, waktu, tempat) {
                  ...
                  <tbody>
                    ...
                    if (mysqli_num_rows($result) > 0) {
                      while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<a href='javascript:;' style='margin-left: 30px;' class='text-secondary font-weight-bold text-xs' data-toggle='tooltip' data-original-title='Delete user' onclick='hapus(\"" . $row['id_p_pelayanan'] . "\")'>";
