          ...
          <div class="col-xl-3 col-sm-6 mb-xl-0 mt-4">
            <a href="majelis" class="text-decoration-none">
              <div class="card shadow-lg border-0" style="border-radius: 1rem; overflow: hidden;">
                ...
                <div class="card-footer p-3">
                  <p class="mb-0">
                    Jumlah Data Majelis <span class="text-success text-sm font-weight-bolder"><?php echo $counts['majelis']; ?> </span> pada Gereja Moria Liliba
                  </p>
                </div>
              </div>
            </a>
          ...
          <div class="col-xl-3 col-sm-6 mb-xl-0 mt-4">
            <a href="rayon" class="text-decoration-none">
              <div class="card shadow-lg border-0" style="border-radius: 1rem; overflow: hidden;">
                ...
                <div class="card-footer p-3">
                  <p class="mb-0">
                    Jumlah Data Rayon <span class="text-success text-sm font-weight-bolder"><?php echo $counts['rayon']; ?> </span> pada Gereja Moria Liliba
                  </p>
                </div>
              </div>
            </a>
          ...
          <div class="col-xl-3 col-sm-6 mb-xl-0 mt-4">
            <a href="permohonan_pelayanan" class="text-decoration-none">
              <div class="card shadow-lg border-0" style="border-radius: 1rem; overflow: hidden;">
                ...
                <div class="card-footer p-3">
                  <p class="mb-0">
                    Jumlah Data Permohonan Pelayanan <span class="text-success text-sm font-weight-bolder"><?php echo $counts['p_pelayanan']; ?> </span> pada Gereja Moria Liliba
                  </p>
                </div>
              </div>
            </a>
          ...
          <div class="col-xl-3 col-sm-6 mb-xl-0 mt-4">
            <a href="jenis_pelayanan" class="text-decoration-none">
              <div class="card shadow-lg border-0" style="border-radius: 1rem; overflow: hidden;">
                ...
                <div class="card-footer p-3">
                  <p class="mb-0">
                    Jumlah Data Jenis Pelayanan <span class="text-success text-sm font-weight-bolder"><?php echo $counts['jenis_pelayanan']; ?> </span> pada Gereja Moria Liliba
                  </p>
                </div>
              </div>
            </a>
          ...
          <div class="col-xl-3 col-sm-6 mb-xl-0 mt-4">
            <a href="pengumuman" class="text-decoration-none">
              <div class="card shadow-lg border-0" style="border-radius: 1rem; overflow: hidden;">
                ...
                <div class="card-footer p-3">
                  <p class="mb-0">
                    Jumlah Data Pengumuman <span class="text-success text-sm font-weight-bolder"><?php echo $counts['pengumuman']; ?> </span> pada Gereja Moria Liliba
                  </p>
                </div>
              </div>
            </a>
          ...
          <div class="col-xl-3 col-sm-6 mb-xl-0 mt-4">
            <a href="pembabtisan" class="text-decoration-none">
              <div class="card shadow-lg border-0" style="border-radius: 1rem; overflow: hidden;">
                ...
                <div class="card-footer p-3">
                  <p class="mb-0">
                    Jumlah Data pembabtisan <span class="text-success text-sm font-weight-bolder"><?php echo $counts['pembabtisan']; ?> </span> pada Gereja Moria Liliba
                  </p>
                </div>
              </div>
            </a>
          ...
          <div class="col-xl-3 col-sm-6 mb-xl-0 mt-4">
            <a href="katekasasi" class="text-decoration-none">
              <div class="card shadow-lg border-0" style="border-radius: 1rem; overflow: hidden;">
                ...
                <div class="card-footer p-3">
                  <p class="mb-0">
                    Jumlah Data Katekasasi <span class="text-success text-sm font-weight-bolder"><?php echo $counts['katekasasi']; ?> </span> pada Gereja Moria Liliba
                  </p>
                </div>
              </div>
            </a>
