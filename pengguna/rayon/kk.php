...
<body translate="no" class="g-sidenav-show bg-gray-200">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <!-- js edit -->
    <script>
      function openEditModal(id_kepala_keluarga, nama, no_hp, username, password) {
        ...
        <div class="col-12">
          <div class="card my-4">
            ...
            <div class="mt-3 p-3 d-flex flex-wrap align-items-center justify-content-center">
              <a href="rayon.php" class="btn btn-secondary m-1"><i class="fas fa-arrow-left"></i> Kembali</a>
              ...
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    ...
                    $count_query = "SELECT COUNT(*) AS total FROM kepala_keluarga WHERE id_rayon = '$id_rayon'" . $search_sql;
                    ...
                    $data_query = "SELECT * FROM kepala_keluarga WHERE id_rayon = '$id_rayon'" . $search_sql . " ORDER BY id_kepala_keluarga DESC LIMIT " . $starting_limit . ", " . $results_per_page;
                    ...
                    if (mysqli_num_rows($result) > 0) {
                      while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<a href='jemaat.php?id_kepala_keluarga=" . $id_kepala_keluarga . "' class='text-secondary font-weight-bold text-xs' data-toggle='tooltip' data-original-title='Detail KK'>";
