...
$select_query = "SELECT fp FROM rayon WHERE id_rayon = '$id_rayon'";
...
// Update nama gambar di tabel rayon berdasarkan id_rayon
$update_query = "UPDATE rayon SET fp = '$filename' WHERE id_rayon = '$id_rayon'";
$update_result = mysqli_query($koneksi, $update_query);

if ($update_result) {
    // Berhasil menyimpan gambar dan update nama gambar di tabel rayon
