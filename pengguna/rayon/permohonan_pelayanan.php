...
<body translate="no" class="g-sidenav-show bg-gray-200">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <!-- js edit -->
    <script>
      function openEditModal(id_p_pelayanan, id_jenis_pelayanan, id_rayon) {
  ...
  <script>
    ...
    function editStatus(id) {
      swal({
          ...
          text: "SeSudah Diteruskan, Anda tidak akan dapat membatalkan data ini!",
          icon: "info",
        ...
        .then((willDelete) => {
          if (willDelete) {
            ...
            xhr.open('POST', 'proses/p_pelayanan/editStatus.php', true);
            ...
            xhr.onload = function() {
              ...
              if (xhr.status === 200) {
                ...
                if (response === 'success') {
                  swal("Sukses!", "Data berhasil disetujui.", "success")
                  loadTable();
                } else {
                  swal("Error", "Gagal menyutujui Data.", "error");
                }
              } else {
                swal("Error", "Terjadi kesalahan saat mengirim data.", "error");
              }
            ...
            swal("Validasi dan Perssetujuan dibatalkan", {
              icon: "info",
            });
          }
        });
