...
<body translate="no" class="g-sidenav-show bg-gray-200">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <div id="popup-tambah" class="popup">
      <div class="popup-content">
        ...
        <form id="form_tambah" action="proses/jemaat/tambah.php" method="POST" enctype="multipart/form-data">
          <input type="hidden" id="id_kepala_keluarga-tambah" name="id_kepala_keluarga" value="<?php echo htmlspecialchars($id_kepala_keluarga); ?>" required>
    ...
    <div id="popup-edit" class="popup">
      <div class="popup-content">
        ...
        <form id="form_edit" action="proses/jemaat/edit.php" method="POST" enctype="multipart/form-data">
          ...
          <input type="hidden" id="id_kepala_keluarga-edit" name="id_kepala_keluarga" value="<?php echo htmlspecialchars($id_kepala_keluarga); ?>" required>
    ...
    <!-- js edit -->
    <script>
      function openEditModal(id_jemaat, nama, no_hp, jenis_kelamin, alamat) {
              ...
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    ...
                    $search_sql = !empty($search_query) ? " AND (nama LIKE '%$search_query%' OR no_hp LIKE '%$search_query%' OR jenis_kelamin LIKE '%$search_query%' OR alamat LIKE '%$search_query%')" : '';
                    $count_query = "SELECT COUNT(*) AS total FROM jemaat WHERE id_kepala_keluarga = '$id_kepala_keluarga'" . $search_sql;
                    ...
                    $data_query = "SELECT * FROM jemaat WHERE id_kepala_keluarga = '$id_kepala_keluarga'" . $search_sql . " ORDER BY id_jemaat DESC LIMIT " . $starting_limit . ", " . $results_per_page;
  ...
  <script>
    ...
    function loadTable() {
      ...
      xhrTable.open('GET', 'proses/jemaat/load_table.php?id_kepala_keluarga=<?php echo $id_kepala_keluarga; ?>', true);
      xhrTable.send();
    }
  </script>
