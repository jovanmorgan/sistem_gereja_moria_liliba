                        ...
                        <div class="table-responsive">
                            <table id="example" class="table table-striped table-bordered display nowrap" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    $search_sql = !empty($search_query) ? " WHERE pendeta.nama_pendeta LIKE '%$search_query%' OR pendeta.alamat LIKE '%$search_query%' OR majelis.nama LIKE '%$search_query%' OR pendeta.username LIKE '%$search_query%' OR pendeta.password LIKE '%$search_query%'" : '';
                                    $count_query = "SELECT COUNT(*) AS total FROM pendeta LEFT JOIN majelis ON pendeta.id_majelis = majelis.id_majelis" . $search_sql;
                                    ...
                                    $data_query = "SELECT pendeta.*, majelis.nama AS nama_majelis FROM pendeta LEFT JOIN majelis ON pendeta.id_majelis = majelis.id_majelis" . $search_sql . " ORDER BY id_pendeta DESC LIMIT " . $starting_limit . ", " . $results_per_page;
                                    ...
                                    if (mysqli_num_rows($result) > 0) {
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            // Check the count of id_pendeta in rayon table
                                            $kk_query = "SELECT COUNT(*) AS total FROM rayon WHERE id_pendeta = '$id_pendeta'";
