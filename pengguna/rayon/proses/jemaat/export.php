                        ...
                        <div class="table-responsive">
                            <table id="example" class="table table-striped table-bordered display nowrap" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    $count_query = "SELECT COUNT(*) AS total FROM jemaat WHERE id_rayon = '$id_rayon'" . $search_sql;
                                    ...
                                    $data_query = "SELECT * FROM jemaat WHERE id_rayon = '$id_rayon'" . $search_sql . " ORDER BY id_jemaat DESC LIMIT " . $starting_limit . ", " . $results_per_page;
