                        ...
                        <div class="card card-body mx-3 mx-md-4 mt-n6">
                            <div class="row gx-4 mb-2">
                                ...
                                <div class="col-auto my-auto">
                                    <div class="h-100">
                                        <h5 class="mb-1">
                                            <?php echo $pendeta['nama']; ?>
                                        </h5>
                                        <p class="mb-0 font-weight-normal text-sm">
                                            Username : <?php echo $pendeta['username']; ?>
                                        </p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-12 col-xl-4">
                                    <div class="card card-plain h-100">
                                        ...
                                        <div class="card-body p-3">
                                            <p class="text-sm">
                                                Selamat datang di akun pendeta Anda. Di sini, Anda dapat mengelola semua
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control p-1" type="text" id="username"
                                                                name="username" value="<?php echo $pendeta['username']; ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control p-1" type="text" id="password"
                                                                name="password" value="<?php echo $pendeta['password']; ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row mt-4">
