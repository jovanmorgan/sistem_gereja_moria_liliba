                                            ...
                                            if ($result) {
                                                ...
                                                if (mysqli_num_rows($result) > 0) {
                                                    ...
                                                    <?php if (!empty($pendeta['fp'])): ?>
                                                        <img class="avatar" src="data_fp/<?php echo $pendeta['fp']; ?>" alt="...">
                                                    <?php else: ?>
                                                        <img class="avatar" src="../../assets/img/anime3.png" alt="Profile Photo">
                                                    <?php endif; ?>
                                                    <h5 class="title"><?php echo $pendeta['nama']; ?></h5>
                                                </div>
                                ...
                                <div class="col-md-8">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <form id="editDataFp">
                                                <div class="row">
                                                    <input type="hidden" class="form-control" name="id_pendeta" id="id_pendeta"
                                                        value="<?php echo $pendeta['id_pendeta']; ?>">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label>Nama</label>
                                                            <input type="text" class="form-control" placeholder="nama" name="nama"
                                                                id="nama" value="<?php echo $pendeta['nama']; ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="form-group">
