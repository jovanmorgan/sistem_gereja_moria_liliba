...
$select_query = "SELECT fp FROM kepala_keluarga WHERE id_kepala_keluarga = '$id_kepala_keluarga'";
...
// Update nama gambar di tabel kepala_keluarga berdasarkan id_kepala_keluarga
$update_query = "UPDATE kepala_keluarga SET fp = '$filename' WHERE id_kepala_keluarga = '$id_kepala_keluarga'";
$update_result = mysqli_query($koneksi, $update_query);

if ($update_result) {
    // Berhasil menyimpan gambar dan update nama gambar di tabel kepala_keluarga
