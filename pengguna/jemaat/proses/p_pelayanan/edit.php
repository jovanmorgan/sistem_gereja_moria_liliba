...
$query_update = "UPDATE p_pelayanan SET id_jenis_pelayanan = '$id_jenis_pelayanan', id_kepala_keluarga = '$id_kepala_keluarga', id_rayon = '$id_rayon', waktu = '$format', tempat = '$tempat_data' WHERE id_p_pelayanan = '$id_p_pelayanan'";
