                                            ...
                                            if ($result) {
                                                ...
                                                if (mysqli_num_rows($result) > 0) {
                                                    ...
                                                    <?php if (!empty($kepala_keluarga['fp'])): ?>
                                                        <img class="avatar" src="data_fp/<?php echo $kepala_keluarga['fp']; ?>" alt="...">
                                                    <?php else: ?>
                                                        <img class="avatar" src="../../assets/img/anime3.png" alt="Profile Photo">
                                                    <?php endif; ?>
                                                    <h5 class="title"><?php echo $kepala_keluarga['nama']; ?></h5>
                                                </div>
                                ...
                                <div class="col-md-8">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <form id="editDataFp">
                                                <div class="row">
                                                    <input type="hidden" class="form-control" name="id_kepala_keluarga" id="id_kepala_keluarga"
                                                        value="<?php echo $kepala_keluarga['id_kepala_keluarga']; ?>">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label>Nama</label>
                                                            <input type="text" class="form-control" placeholder="nama" name="nama"
                                                                id="nama" value="<?php echo $kepala_keluarga['nama']; ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" placeholder="Username"
                                                                ...
                                                                value="<?php echo $kepala_keluarga['username']; ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" placeholder="Password"
                                                                ...
                                                                value="<?php echo $kepala_keluarga['password']; ?>">
                                                        </div>
                                                    </div>
                                                </div>
